...
const Reset = () => {
  ...
  const list = renderList[renderList.length - 1].list.children.children.data;
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <Formik
        initialValues={initValues.resetPassword}
        validationSchema={Yup.object().shape(Validate.resetPassword)}
        enableReinitialize
        onSubmit={(value) => {
          dispatch(resetNoti());
          dispatch(handleAuth({ type: "resetPassword", data: value })).then((res) => {
